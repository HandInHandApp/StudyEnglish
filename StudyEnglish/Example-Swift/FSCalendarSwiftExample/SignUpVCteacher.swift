...
class SignUpVCteacher: UIViewController, UIImagePickerControllerDelegate, UINavigationControllerDelegate {
  ...
  @IBOutlet weak var emailTxt: UITextField!
    ...
    @IBOutlet weak var engencyPhone: UITextField!
  ...
  override func viewDidLoad() {
    ...
    phoneTxt.frame = CGRect(x: rightGap,
                            ...
                            width: eidtWidth/2 - CGFloat(10),
                            height: eidtHigh)
    engencyPhone.frame = CGRect(x: rightGap + eidtWidth/2 + CGFloat(10),
                                   y: emailTxt.frame.origin.y + topGap,
                                   width: eidtWidth/2 - CGFloat(10),
                                   height: eidtHigh)
